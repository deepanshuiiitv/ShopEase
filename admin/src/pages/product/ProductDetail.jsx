...
export default function ProductDetail() {
  ...
  if (!product) {
    return (
      <div className="max-w-xl mx-auto mt-12 text-center text-red-600">No product data found.</div>
    );
  }

  return (
    <div className="max-w-xl mx-auto bg-white rounded-xl shadow-lg p-8 mt-12">
      <h1 className="text-3xl font-extrabold text-blue-700 mb-6">Product Details</h1>
