        ...
        <table className="min-w-full divide-y divide-blue-200">
          ...
          <tbody className="bg-white divide-y divide-blue-100">
            {sales.map((sale, idx) => (
              ...
              >
                <td className="px-6 py-4 text-sm font-medium text-blue-900">{sale.id}</td>
                <td className="px-6 py-4 text-sm text-blue-900">{sale.product}</td>
                <td className="px-6 py-4 text-sm text-blue-900">{sale.customer}</td>
                <td className="px-6 py-4 text-sm text-blue-900">{sale.amount}</td>
                <td className="px-6 py-4 text-sm text-blue-900">{sale.date}</td>
